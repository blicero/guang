...
# Time-stamp: <2022-11-08 02:16:29 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-08 Di 02:16]
   | Headline                        | Time      |         |          |         |         |
   |---------------------------------+-----------+---------+----------+---------+---------|
   | *Total time*                    | *2d 1:18* |         |          |         |         |
   |---------------------------------+-----------+---------+----------+---------+---------|
   | Guang                           | 2d 1:18   |         |          |         |         |
   | \_  Components                  |           | 2d 1:18 |          |         |         |
   | \_    Database                  |           |         |     0:58 |         |         |
   | \_      SQLite                  |           |         |          |    0:44 |         |
   | \_      Pool                    |           |         |          |    0:11 |         |
   | \_      Major cleanup [2/2]     |           |         |          |    0:03 |         |
   | \_        Package               |           |         |          |         |    0:03 |
   | \_    Web interface [2/4]       |           |         | 1d 13:55 |         |         |
   | \_      Major overhaul [1/3]    |           |         |          | 1d 9:40 |         |
   | \_        Live updates          |           |         |          |         | 1d 5:32 |
