...
# Time-stamp: <2022-11-24 00:49:41 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-24 Do 00:49]
   | Headline                           | Time       |          |          |         |          |          |
   |------------------------------------+------------+----------+----------+---------+----------+----------|
   | *Total time*                       | *3d 22:42* |          |          |         |          |          |
   |------------------------------------+------------+----------+----------+---------+----------+----------|
   | Guang                              | 3d 22:42   |          |          |         |          |          |
   | \_  Components                     |            | 3d 22:42 |          |         |          |          |
   | \_    Database                     |            |          |     0:58 |         |          |          |
   | \_      SQLite                     |            |          |          |    0:44 |          |          |
   | \_      Pool                       |            |          |          |    0:11 |          |          |
   | \_      Major cleanup [2/2]        |            |          |          |    0:03 |          |          |
   | \_        Package                  |            |          |          |         |     0:03 |          |
   | \_    Web interface [4/6]          |            |          | 3d 11:19 |         |          |          |
   | \_      Major overhaul [3/5]       |            |          |          | 3d 7:04 |          |          |
   | \_        Live updates             |            |          |          |         |  1d 8:10 |          |
   | \_        Knobs and Switches [1/2] |            |          |          |         | 1d 18:46 |          |
   | \_          UI                     |            |          |          |         |          | 1d 18:46 |
