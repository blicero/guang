...
# Time-stamp: <2022-11-11 00:11:38 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-11 Fr 00:11]
   | Headline                           | Time       |          |         |          |         |      |
   |------------------------------------+------------+----------+---------+----------+---------+------|
   | *Total time*                       | *2d 13:17* |          |         |          |         |      |
   |------------------------------------+------------+----------+---------+----------+---------+------|
   | Guang                              | 2d 13:17   |          |         |          |         |      |
   | \_  Components                     |            | 2d 13:17 |         |          |         |      |
   | \_    Database                     |            |          |    0:58 |          |         |      |
   | \_      SQLite                     |            |          |         |     0:44 |         |      |
   | \_      Pool                       |            |          |         |     0:11 |         |      |
   | \_      Major cleanup [2/2]        |            |          |         |     0:03 |         |      |
   | \_        Package                  |            |          |         |          |    0:03 |      |
   | \_    Web interface [3/6]          |            |          | 2d 1:54 |          |         |      |
   | \_      Major overhaul [2/5]       |            |          |         | 1d 21:39 |         |      |
   | \_        Live updates             |            |          |         |          | 1d 8:10 |      |
   | \_        Knobs and Switches [0/2] |            |          |         |          |    9:21 |      |
   | \_          UI                     |            |          |         |          |         | 9:21 |
