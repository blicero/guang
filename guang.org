...
# Time-stamp: <2022-11-24 21:01:51 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-24 Do 21:01]
   | Headline                           | Time      |         |          |         |          |          |
   |------------------------------------+-----------+---------+----------+---------+----------+----------|
   | *Total time*                       | *4d 1:07* |         |          |         |          |          |
   |------------------------------------+-----------+---------+----------+---------+----------+----------|
   | Guang                              | 4d 1:07   |         |          |         |          |          |
   | \_  Components                     |           | 4d 1:07 |          |         |          |          |
   | \_    Database                     |           |         |     0:58 |         |          |          |
   | \_      SQLite                     |           |         |          |    0:44 |          |          |
   | \_      Pool                       |           |         |          |    0:11 |          |          |
   | \_      Major cleanup [2/2]        |           |         |          |    0:03 |          |          |
   | \_        Package                  |           |         |          |         |     0:03 |          |
   | \_    Web interface [5/6]          |           |         | 3d 13:44 |         |          |          |
   | \_      Major overhaul [4/5]       |           |         |          | 3d 9:29 |          |          |
