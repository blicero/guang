...
# Time-stamp: <2022-11-12 23:20:40 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-12 Sa 23:20]
   | Headline                           | Time      |         |          |         |         |       |
   |------------------------------------+-----------+---------+----------+---------+---------+-------|
   | *Total time*                       | *3d 1:27* |         |          |         |         |       |
   |------------------------------------+-----------+---------+----------+---------+---------+-------|
   | Guang                              | 3d 1:27   |         |          |         |         |       |
   | \_  Components                     |           | 3d 1:27 |          |         |         |       |
   | \_    Database                     |           |         |     0:58 |         |         |       |
   | \_      SQLite                     |           |         |          |    0:44 |         |       |
   | \_      Pool                       |           |         |          |    0:11 |         |       |
   | \_      Major cleanup [2/2]        |           |         |          |    0:03 |         |       |
   | \_        Package                  |           |         |          |         |    0:03 |       |
   | \_    Web interface [3/6]          |           |         | 2d 14:04 |         |         |       |
   | \_      Major overhaul [2/5]       |           |         |          | 2d 9:49 |         |       |
   | \_        Live updates             |           |         |          |         | 1d 8:10 |       |
   | \_        Knobs and Switches [0/2] |           |         |          |         |   21:31 |       |
   | \_          UI                     |           |         |          |         |         | 21:31 |
