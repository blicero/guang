...
# Time-stamp: <2022-11-08 18:54:24 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2022-11-08 Di 18:54]
   | Headline                        | Time      |         |          |          |         |
   |---------------------------------+-----------+---------+----------+----------+---------|
   | *Total time*                    | *2d 3:56* |         |          |          |         |
   |---------------------------------+-----------+---------+----------+----------+---------|
   | Guang                           | 2d 3:56   |         |          |          |         |
   | \_  Components                  |           | 2d 3:56 |          |          |         |
   | \_    Database                  |           |         |     0:58 |          |         |
   | \_      SQLite                  |           |         |          |     0:44 |         |
   | \_      Pool                    |           |         |          |     0:11 |         |
   | \_      Major cleanup [2/2]     |           |         |          |     0:03 |         |
   | \_        Package               |           |         |          |          |    0:03 |
   | \_    Web interface [3/4]       |           |         | 1d 16:33 |          |         |
   | \_      Major overhaul [2/3]    |           |         |          | 1d 12:18 |         |
